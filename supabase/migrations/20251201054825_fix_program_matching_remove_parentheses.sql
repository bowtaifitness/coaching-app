/*
  # Fix Program Matching Pattern
  
  1. Problem
    - Function searches for "%(Full Gym)%" with parentheses
    - Actual titles are "12-Week 3-Day Golf Performance 1 Full Gym" without parentheses
    - This causes matching to fail and fall back to wrong programs
    
  2. Changes
    - Remove parentheses from the ILIKE pattern
    - Search for "%Full Gym%" instead of "%(Full Gym)%"
*/
...
BEGIN
  ...
  -- Find matching program (without parentheses in pattern)
