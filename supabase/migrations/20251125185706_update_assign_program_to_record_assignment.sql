/*
  # Update assign_program_from_intake to Record Program Assignment

  1. Changes
    - Create client_program_assignments record when assigning program
    - Return program_assignment_id in response
    - Mark any existing active programs as cancelled
    
  2. Purpose
    - Clients have explicit record of assigned program
    - UI can query and display "Current Program"
