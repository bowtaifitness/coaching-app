                                      ...
                                      return (
                                        ...
                                        >
                                          ...
                                          <td className="py-1.5 px-1 text-center">
                                            {s.completed ? (
                                              <CheckCircle className="h-3.5 w-3.5 text-blue-500 inline" />
                                            ) : (
                    ...
                    <div className="border-t border-gray-200 pt-4">
                      ...
                      <div className="flex gap-2">
                        ...
                        <button
                          ...
                          className="self-end px-4 py-2.5 min-h-[44px] bg-blue-500 text-white rounded-lg hover:bg-blue-600 disabled:opacity-50 flex items-center gap-1 text-sm font-medium"
                        >
                          {savingFeedback ? (
